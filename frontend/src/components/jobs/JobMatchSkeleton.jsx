  ...
  return (
    <div className="space-y-5" aria-live="polite" aria-busy="true">
      <div className="flex items-center gap-3 rounded-xl border border-indigo-200 bg-indigo-50 px-4 py-3 text-sm text-indigo-800 dark:border-indigo-900 dark:bg-indigo-950/40 dark:text-indigo-200">
        ...
        Extracting job requirements and comparing them with your resume. This can take up to a minute.
      </div>
      <div className="h-48 animate-pulse rounded-3xl bg-slate-200/70 dark:bg-slate-800" />
      <div className="grid gap-4 md:grid-cols-2"><div className="h-52 animate-pulse rounded-2xl bg-slate-200/70 dark:bg-slate-800" /><div className="h-52 animate-pulse rounded-2xl bg-slate-200/70 dark:bg-slate-800" /></div>
    </div>
  )
}
